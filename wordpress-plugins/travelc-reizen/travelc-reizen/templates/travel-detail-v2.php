...
<!-- Config data for external JS -->
<div id="tc2DataConfig" style="display:none"><?php echo htmlspecialchars(json_encode(['primaryColor' => $primary_color, 'travelTitle' => $title], JSON_UNESCAPED_SLASHES), ENT_QUOTES, 'UTF-8'); ?></div>
