...
export function TravelDocsVouchers() {
  return (
    <div className="p-6">
      <div className="max-w-7xl mx-auto">
        ...
        <div className="flex items-center justify-between mb-8">
          <div>
            ...
            <p className="text-gray-500 mt-1">Maak en beheer reisvouchers voor je klanten</p>
          </div>
        ...
        <div className="flex items-center gap-3 mb-6">
          <div className="flex-1 relative">
            ...
            <input
              type="text"
              placeholder="Zoek vouchers op klantnaam, boekingsnummer..."
        ...
        <div className="bg-white rounded-2xl border border-gray-200 shadow-sm">
          <div className="flex flex-col items-center justify-center py-20 px-6 text-center">
            ...
            <h3 className="text-xl font-semibold text-gray-900 mb-2">Nog geen vouchers</h3>
            <p className="text-gray-500 max-w-md mb-6">
              Genereer professionele vouchers voor hotels, excursies, transfers en meer. Automatisch gevuld met boekingsdata.
            </p>
