...
function toDbRow(offerte: Offerte) {
  return {
    ...
    hero_images: offerte.hero_images || [],
    ...
    rejected_at: offerte.rejected_at || null,
    valid_until: offerte.valid_until || null,
    client_response: offerte.client_response || null,
    client_response_note: offerte.client_response_note || null,
...
function fromDbRow(row: any): Offerte {
  return {
    ...
    client_response_note: row.client_response_note,
...
export const offerteService = {
  ...
  async duplicate(offerte: Offerte): Promise<Offerte> {
    const duplicate: Offerte = {
      ...
      client_response: undefined,
      client_response_note: undefined,
